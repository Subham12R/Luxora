...
const FilterSidebar = () => {
    ...
    const materials = ["Cotton", "Polyester", "Denim"];
  ...
  return (
    <div className="p-4">
        ...
        <div className="mb-6">
            ...
            <input value={priceRange[1]} onChange={handlePriceChange} type="range" name="priceRange" min={0} max={100} className="w-full h-2 bg-gray-300 rounded-lg apperance-none cursor-pointer" />
