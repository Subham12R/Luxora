...
const FeaturedCollection = () => {
  return (
    <section className='py-16 px-4 lg:px-0 '>
        <div className='container mx-auto flex flex-col-reverse lg:flex-row items-center bg-green-50 lg:rounded-3xl '>
            ...
            <p className='text-lg text-gray-600 mb-6'>
                Discover high quality apparel for men, women and kids. Shop online with fast worldwide shipping.
