  ...
  return (
    <>
      <nav className="container mx-auto flex items-center justify-between py-4 px-6 ">
        {/* Logo Section */}
        <div>
            <Link to="/" className="text-3xl font-semibold tracking-wider">Rabbit</Link>
        </div>
        ...
        <div className="flex items-center space-x-4">
            <Link to="/admin" className="block bg-black rounded-xl text-sm text-white py-2 px-3">Admin</Link>
            ...
            {/* Hamburger Icon */}
            <button className="md:hidden hover:text-black" onClick={toggleNavDrawer}>
      ...
      <div
       className={`fixed top-0 left-0 w-3/4 h-full sm:w-1/2 md:w-1/3 bg-white shadow-lg transform transition-transform duration-300 z-50 ${navDrawerOpen ? 'translate-x-0' : '-translate-x-full'}`}
       >
